...
<link href='http://api.youziku.com/webfont/CSS/571c4dc1f629d80b1866fb8e' rel='stylesheet' type='text/css' />
</head>
<body <?php body_class(); ?>>
...
<div class="container-inner">
 <div class="yusi-logo">
                    <a title="少年，撸多了吧？" href="/">
                        <h1 class="shake shake-crazy">
                                                        <span style="font-family:STXingkai7d157f2a447d;" class="yusi-mono"><?php bloginfo('name'); ?></span>
                                                        <span style="font-family:lixukexingshu2ebb904a5447d;" class="yusi-bloger"><?php bloginfo('description'); ?></span>
                                                    </h1>
                    </a>
    </div>
</div>
