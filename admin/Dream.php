...
function mytheme_add_admin() {
    ...
    if ( $_GET['page'] == basename(__FILE__) ) {
        if ( 'save' == $_REQUEST['action'] ) {
            ...
            header("Location: admin.php?page=Dream.php&saved=true");
            die;
        }
    }
...
function mytheme_admin() {
    global $themename, $options;
    $i=0;
    if ( $_REQUEST['saved'] ) echo '<div class="updated settings-error"><p>'.$themename.'设置保存成功</p></div>';
?>

<div class="wrap d_wrap">
    <link rel="stylesheet" href="<?php bloginfo('template_url') ?>/admin/admin.css"/>
    <h2><?php echo $themename; ?>设置
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="d_themedesc"><input class="button-primary" type="button" value="访问网站" onclick="window.open('http://Meowv.com')">
    ...
    <tr>
	   ...
	   <tr>
        ...
        <td>
           ...
           <br>您的网站分类目录对应的ID：<span class="d_tip"><?php show_category(); ?></span></br>
		</td>
    </tr>
    <tr>
 ...
 <tr>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
				...
				<span class="d_tip">填写腾讯微博首页地址</span>
            </label>
   ...
   <tr>
        ...
        <td>
            ...
            订阅号：<input class="d_inp_short" name="d_weixin" id="d_weixin" type="text" value="<?php echo dopt('d_weixin'); ?>"><span class="d_tip">微信图片命名为weixin.gif放在主题img目录下即可。</span>
        </td>
    </tr>
   <tr>
        ...
        <td>
			...
			<span class="d_tip">填写QQ在线客服网址</span>
        </td>
    </tr>
   <tr>
        ...
        <td>
			...
			<span class="d_tip">建议使用QQ邮箱邮我组件</span>
        </td>
    </tr>
    <tr>
